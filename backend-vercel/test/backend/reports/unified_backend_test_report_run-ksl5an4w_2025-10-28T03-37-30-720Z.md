...
**Generated**: 2025-10-28T03:37:30.721Z
...
- **Failed**: ❌ 3
- **Success Rate**: 25.0%
- **Total Duration**: 13.07s

## Test Results Summary

| Test | Status | Duration | Exit Code |
|------|--------|----------|-----------|
| test\backend\ai-feedback | ❌ FAIL | 8.67s | 1 |
| test\backend\file-crud | ❌ FAIL | 2.61s | 1 |
| test\backend\revenuecat-webhook | ❌ FAIL | 1.26s | 1 |
| test\backend\config-status | ✅ PASS | 534ms | 0 |
