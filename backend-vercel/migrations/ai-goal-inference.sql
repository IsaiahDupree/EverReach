-- AI Goal Inference System Migration
-- Enables implicit goal discovery from user behavior and notes
-- Created: 2025-10-13

-- ============================================================================
-- 1. Add Explicit Goal Fields to User Profiles
-- ============================================================================
...
COMMENT ON COLUMN user_profiles.personal_goal IS 'User-set personal development goal';
COMMENT ON COLUMN user_profiles.networking_goal IS 'User-set networking/relationship goal';
COMMENT ON COLUMN user_profiles.business_goal IS 'User-set business/revenue goal';
...
CREATE INDEX idx_ai_user_context_analyzed ON ai_user_context(last_analyzed_at);
...
CREATE TRIGGER user_profile_goals_updated
...
CREATE INDEX IF NOT EXISTS idx_user_profiles_goals 
