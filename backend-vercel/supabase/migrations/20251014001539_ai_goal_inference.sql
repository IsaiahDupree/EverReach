...
DROP POLICY IF EXISTS "Service role can manage AI context" ON ai_user_context;
DROP POLICY IF EXISTS "Users can read own AI context" ON ai_user_context;
DROP POLICY IF EXISTS "Users cannot modify AI context" ON ai_user_context;
DROP POLICY IF EXISTS "Users cannot update AI context" ON ai_user_context;
...
DROP TRIGGER IF EXISTS user_profile_goals_updated ON profiles;
