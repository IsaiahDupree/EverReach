-- ================================================
-- FIXED: Clean Up Test Data & Add Realistic Data
-- ================================================

-- STEP 1: Clean up test data (fixed tags comparison)
...
-- STEP 2: Add realistic contacts (fixed phones field)
WITH user_info AS (
  SELECT 
    u.id as user_id,
...
-- STEP 3: Add recent interactions (fixed query syntax)
...
JOIN contacts c ON c.display_name = t.contact_name 
  AND c.user_id = (SELECT id FROM auth.users WHERE email = 'isaiahdupree33@gmail.com' LIMIT 1);
