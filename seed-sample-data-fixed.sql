...
-- FIXED: Using only confirmed valid channel values
-- =====================================================
...
BEGIN
  ...
  -- Changed all 'web' to 'app' since 'web' isn't in the actual enum
  ...
  VALUES
    ...
    (test_user_id, 'landing_view', NOW() - INTERVAL '30 days', test_campaign_id, 'app', 5),
    (test_user_id, 'email_submitted', NOW() - INTERVAL '29 days', test_campaign_id, 'app', 30),
    (test_user_id, 'identity_enriched', NOW() - INTERVAL '29 days', test_campaign_id, 'app', 10),
