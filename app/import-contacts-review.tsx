...
import { trackContactImportEvent } from '@/lib/metaServerEvents';
...
export default function ImportContactsReviewScreen() {
  ...
  const handleImport = async () => {
    ...
    try {
      ...
      // Track contact import with Meta for ad attribution
      trackContactImportEvent('', '', result.imported_contacts);
