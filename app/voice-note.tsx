...
import { trackVoiceNoteEvent } from '@/lib/metaServerEvents';
import { 
    ...
    if (transcript) {
      try {
        if (contextScope === 'about_person' && selectedPersonId) {
          ...
          // Track with Meta for ad attribution
          trackVoiceNoteEvent('', '');
        } else {
          ...
          <View style={styles.modalOverlay}>
            <View style={styles.modalContent}>
              ...
              <Text style={styles.modalMessage}>
                To record voice notes, we need access to your microphone. Your audio will only be used to create transcriptions and is processed securely.
              </Text>
              ...
              <View style={styles.modalActions}>
                <TouchableOpacity 
                  ...
                  onPress={() => {
                    ...
                    screenAnalytics.track('permission_prompt_cancelled', {});
                  }}
                >
