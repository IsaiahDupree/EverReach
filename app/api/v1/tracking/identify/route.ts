 ...
 * 
 * Endpoint for identifying users and setting user properties.
 * This is called after sign-in to link anonymous events to the user.
 */
...
interface IdentifyPayload {
  ...
  anonymous_id?: string; // For linking anonymous sessions
}
