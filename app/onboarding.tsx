...
export default function OnboardingFlow() {
  ...
  const handleComplete = async () => {
    ...
    // Fire Meta Pixel Activate event (single activation point for ads optimization)
    try {
      await trackEvent('Activate', {
        content_name: 'Onboarding Completed',
        activation_type: 'onboarding_completed',
      });
      console.log('🎯 Fired Activate event for onboarding completion');
    } catch (error) {
      console.warn('Failed to track Activate event:', error);
    }
