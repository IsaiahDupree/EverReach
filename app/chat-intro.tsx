...
export default function ChatIntroScreen() {
  ...
  // Keyboard swipe down to dismiss functionality
  const panResponder = useRef(
    PanResponder.create({
      onMoveShouldSetPanResponder: (evt, gestureState) => {
        // Only respond to downward swipes when keyboard is visible
  ...
  const handleSendQuery = () => {
    if (inputText.trim()) {
      router.push({
        pathname: '/(tabs)/chat',
        params: { initialQuery: inputText.trim() }
      });
    }
  };
  ...
  const shouldShowTrendingContent = true; // Always show trending content, users can scroll to see it
      ...
      >
        ...
        <View style={styles.inputContainer}>
          <View style={[styles.inputBar, { backgroundColor: theme.colors.surface, borderColor: theme.colors.border }]}>
            ...
            <TouchableOpacity 
              style={styles.micBtn} 
              onPress={() => console.log('Voice input not implemented')}
            >
        ...
        {/* Timeframe Selector - always show, users can scroll to see */}
        {shouldShowTrendingContent && (
        ...
        {/* Trending Queries - always show, users can scroll to see */}
        {shouldShowTrendingContent && (
        ...
        {/* Category Breakdown - always show, users can scroll to see */}
        {shouldShowTrendingContent && (
        ...
        {/* Help Text - always show, users can scroll to see */}
        {shouldShowTrendingContent && (
