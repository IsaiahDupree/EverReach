// AI Context & Actions Smoke Test (automated-tests style)
// Usage (PowerShell):
//   $env:BACKEND_BASE = "https://ever-reach-be.vercel.app"
//   $env:TEST_ORIGIN  = "https://everreach.app"
//   # Token strategy A: let the test sign in via Supabase (recommended for CI)
...
//   node ./test/automated-tests/ai-context-actions.smoke.mjs
...
async function main() {
  ...
  const outPath = `test/automated-tests/reports/ai_context_actions_${ts}.md`;
