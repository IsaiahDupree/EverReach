...
**Test Run ID**: `WRyYpfzL`  
**Generated**: 2025-10-23 16:28:29  
...
| Variable | Value |
|----------|-------|
| Backend URL | `https://backend-vercel-b9m5qpazo-isaiahduprees-projects.vercel.app` |
...
**Start Time**: 2025-10-23 16:28:17  
**End Time**: 2025-10-23 16:28:29  
**Total Duration**: 11.79 seconds  
...
**Error Output**:
```
(node:89532) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
  âŒ Failed: API Error (500): Failed to fetch attribution data
  âŒ Failed: API Error (500): Failed to fetch persona data
  âŒ Failed: API Error (500): Failed to fetch persona data
  âŒ Failed: API Error (500): Internal server error
  âŒ Failed: API Error (500): Failed to fetch funnel data
  âŒ Failed: API 
```

> ðŸ›‘ **Critical test failed - remaining tests in bucket skipped**
**Bucket Summary**: 0/4 passed, 1 failed, 3 skipped
**Bucket Duration**: 6.49s
...
**Failed**: âŒ 5
**Skipped**: â­ï¸ 8
**Total Duration**: 11.74s (0.20 min)
**Completed**: 2025-10-23T20:28:29.371Z

### Bucket Breakdown

**1. Marketing Intelligence & Analytics**: 0/4 passed (0.0%) - 6.49s
**2. Campaign Automation & Lifecycle**: 0/4 passed (0.0%) - 1.47s
**3. Communication Integration**: 0/2 passed (0.0%) - 1.26s
...
Last checked: 2025-10-23 16:28:29
- **Status**: healthy âœ…
- **Version**: 1.0.0
- **Database**: healthy (Latency: 94ms)
- **Stripe**: configured
- **OpenAI**: configured
...
- **Report File**: `C:\Users\Isaia\Documents\Coding\PersonalCRM\test\agent\reports\comprehensive_test_report_WRyYpfzL_2025-10-23T16-28-16.md`
