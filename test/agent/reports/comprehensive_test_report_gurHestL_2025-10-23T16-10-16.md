...
**Test Run ID**: `gurHestL`  
**Generated**: 2025-10-23 16:10:26  
...
| Variable | Value |
|----------|-------|
| Backend URL | `https://backend-vercel-39iw6qlwi-isaiahduprees-projects.vercel.app` |
...
**Start Time**: 2025-10-23 16:10:17  
**End Time**: 2025-10-23 16:10:26  
**Total Duration**: 8.71 seconds  
...
**Error Output**:
```
(node:73900) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
...
**Failed**: âŒ 5
**Skipped**: â­ï¸ 8
**Total Duration**: 8.66s (0.14 min)
**Completed**: 2025-10-23T20:10:26.178Z

### Bucket Breakdown

**1. Marketing Intelligence & Analytics**: 0/4 passed (0.0%) - 4.82s
**2. Campaign Automation & Lifecycle**: 0/4 passed (0.0%) - 0.47s
**3. Communication Integration**: 0/2 passed (0.0%) - 1.08s
**4. Backend Infrastructure**: 1/4 passed (25.0%) - 2.29s
...
Last checked: 2025-10-23 16:10:26
- **Status**: healthy âœ…
- **Version**: 1.0.0
- **Database**: healthy (Latency: 107ms)
- **Stripe**: configured
- **OpenAI**: configured
...
- **Report File**: `C:\Users\Isaia\Documents\Coding\PersonalCRM\test\agent\reports\comprehensive_test_report_gurHestL_2025-10-23T16-10-16.md`
