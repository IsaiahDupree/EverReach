...
**Start Time**: 2025-10-23 15:27:14  
**End Time**: 2025-10-23 15:27:26  
**Total Duration**: 11.73 seconds  
...
**Error Output**:
```
(node:110716) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
  âŒ Failed: API Error (500): Failed to fetch attribution data
  âŒ Failed: API Error (500): Failed to fetch attribution data
  âŒ Failed: API Error (500): Failed to fetch attribution data
  âŒ Failed: API Error (500): Failed to fetch magnetism data
  âŒ Failed: API Error (500): Failed to fetch magnetism 
```

> ðŸ›‘ **Critical test failed - remaining tests in bucket skipped**
**Bucket Summary**: 0/4 passed, 1 failed, 3 skipped
**Bucket Duration**: 7.24s
...
**Failed**: âŒ 5
**Skipped**: â­ï¸ 8
**Total Duration**: 11.68s (0.19 min)
**Completed**: 2025-10-23T19:27:26.448Z

### Bucket Breakdown

**1. Marketing Intelligence & Analytics**: 0/4 passed (0.0%) - 7.24s
**2. Campaign Automation & Lifecycle**: 0/4 passed (0.0%) - 0.46s
**3. Communication Integration**: 0/2 passed (0.0%) - 1.57s
**4. Backend Infrastructure**: 1/4 passed (25.0%) - 2.41s
...
Last checked: 2025-10-23 15:27:26
- **Status**: healthy âœ…
- **Version**: 1.0.0
- **Database**: healthy (Latency: 99ms)
- **Stripe**: configured
- **OpenAI**: configured
...
- **Report File**: `C:\Users\Isaia\Documents\Coding\PersonalCRM\test\agent\reports\comprehensive_test_report_fDJPOGFl_2025-10-23T15-27-14.md`
