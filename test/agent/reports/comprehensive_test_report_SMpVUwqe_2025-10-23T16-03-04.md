...
**Test Run ID**: `SMpVUwqe`  
**Generated**: 2025-10-23 16:03:14  
...
**Start Time**: 2025-10-23 16:03:05  
**End Time**: 2025-10-23 16:03:14  
**Total Duration**: 8.72 seconds  
...
(Use `node --trace-deprecation ...` to show where the warning was created)
  ...
  âŒ Failed: API Error (500): Failed to fetch magnetism d
```
...
Last checked: 2025-10-23 16:03:14
- **Status**: healthy âœ…
- **Version**: 1.0.0
- **Database**: healthy (Latency: 54ms)
- **Stripe**: configured
- **OpenAI**: configured
...
- **Report File**: `C:\Users\Isaia\Documents\Coding\PersonalCRM\test\agent\reports\comprehensive_test_report_SMpVUwqe_2025-10-23T16-03-04.md`
